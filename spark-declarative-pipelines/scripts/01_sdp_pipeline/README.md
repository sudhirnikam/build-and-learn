...
This folder defines all source code for the '01_sdp_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_01_sdp_pipeline.py" to get familiar with the syntax.
